...
public class Rocket extends SmoothMover
{
     ...
     */
    /**
     * checkKeys checks to see if specific keys are pressed
     * 
     * @param there are no parameters
     * @return nothing is returned
     */
     ...
     */
    /**
     * fire declares bullet and sets its location, along with setting the reload delay.
     * 
     * @param there are no paprameters
     * @return nothing is returned
     */
    public void fire()
    {
     ...
     */
    /**
     * startProtonWave activates the proton wave
     * 
     * @param there are no parameters
     * @return nothing is returned
     */
     ...
     */
    /**
     * ignite sets the image of rocket depending if boosterOn is true or false.
     * 
     * @param boolean boosterOn which will change the image of rocket if is true
     * @return nothing is returned
     */
     ...
     */
    /**
     * checkCollision checks to see if the asteroid is at the end of the world
     * 
     * @param there are non
     * @return nothing is returned
     */
