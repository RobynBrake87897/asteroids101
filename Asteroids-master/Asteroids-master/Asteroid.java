...
public class Asteroid extends SmoothMover
{
     ...
     */
    /**
     * setSize sets the size and stability of rocket
     * 
     * @param int size
     * @return nothing is returned
     */
     ...
     */
    /**
     * hit activates the consequences if rocket comes in contact with rocket
     * 
     * @param int damage
     * @return nothing is returned
     */
     ...
     */
    /**
     * breakUp runs a loop as many times as the asteroid needs to break up, and when the 
     * asteroid meets a certain size it is deleted
     * 
     * @param int numBreakUp
     * @return nothing is returned
     */
    public void breakUp(int numBreakUp)
    {
        ...
        else
        {
            ...
            for(int i = 0; i < numBreakUp; i++)
            {
                ...
                debris = new Asteroid(size/numBreakUp);
